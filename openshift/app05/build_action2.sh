...
time cat ${OPENSHIFT_TMP_DIR}/strip_starget.txt | xargs -0ti -L1 strip --strip-all --preserve-dates --verbose {}
time cat ${OPENSHIFT_TMP_DIR}/strip_starget.txt | xargs -0t -P 1 -L 1 strip --strip-all --preserve-dates --verbose
time cat ${OPENSHIFT_TMP_DIR}/strip_starget.txt | xargs -0t -P 1 -n 1 strip --strip-all --preserve-dates --verbose
