...
EXIT
__HEREDOC__
# GRANT ALL PRIVILEGES ON ttrss.* TO __OPENSHIFT_MYSQL_DB_USERNAME__@__OPENSHIFT_MYSQL_DB_HOST__ IDENTIFIED BY '__OPENSHIFT_MYSQL_DB_PASSWORD__';
# FLUSH PRIVILEGES;

perl -pi -e 's/__OPENSHIFT_MYSQL_DB_USERNAME__/$ENV{OPENSHIFT_MYSQL_DB_USERNAME}/g' create_database_ttrss.txt
perl -pi -e 's/__OPENSHIFT_MYSQL_DB_HOST__/$ENV{OPENSHIFT_MYSQL_DB_HOST}/g' create_database_ttrss.txt
perl -pi -e 's/__OPENSHIFT_MYSQL_DB_PASSWORD__/$ENV{OPENSHIFT_MYSQL_DB_PASSWORD}/g' create_database_ttrss.txt
